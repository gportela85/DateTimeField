...
Ext.define('Ext.ux.DateTimeField', {
    ...
    mimicBlur: function(e) {
      ...
      collapseIf: function(e) {
        ...
        if (!me.isDestroyed && !e.within(me.bodyEl, false, true) && !e.within(me.picker.el, false, true) && !e.within(me.picker.timePicker.el, false, true) && !me.isEventWithinPickerLoadMask(e)) {
          me.collapse();
        }
      },
      onExpand: function() {
